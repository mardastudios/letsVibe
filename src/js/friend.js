...
function init() {
    ...
    var [my_xSlider, my_ySlider, my_zSlider] = [$(".my-xcon-slider"), $(".my-ycon-slider"), $(".my-zcon-slider")];
    var [my_xPos_view, my_yPos_view, my_zPos_view] = [$('#my-xpos-value'), $('#my-ypos-value'), $('#my-zpos-value')];
    
    var [my_xPos_value, my_yPos_value, my_zPos_value] = [$('<p></p>'), $('<p></p>'), $('<p></p>')];
    
    my_xPos_value.text(my_xSlider.val()); my_yPos_value.text(my_ySlider.val()); my_zPos_value.text(my_zSlider.val());
    my_xPos_view.append(my_xPos_value); my_yPos_view.append(my_yPos_value); my_zPos_view.append(my_zPos_value);
    ...
    var [friend_xSlider, friend_ySlider, friend_zSlider] = [$(".friend-xcon-slider"), $(".friend-ycon-slider"), $(".friend-zcon-slider")];
    var [friend_xPos_view, friend_yPos_view, friend_zPos_view] = [$('#friend-xpos-value'), $('#friend-ypos-value'), $('#friend-zpos-value')];
    
    var [friend_xPos_value, friend_yPos_value, friend_zPos_value] = [$('<p></p>'), $('<p></p>'), $('<p></p>')];
    
    friend_xPos_value.text(friend_xSlider.val()); friend_yPos_value.text(friend_ySlider.val()); friend_zPos_value.text(friend_zSlider.val());
    friend_xPos_view.append(friend_xPos_value); friend_yPos_view.append(friend_yPos_value); friend_zPos_view.append(friend_zPos_value);
    ...
    var [tv_xSlider, tv_ySlider, tv_zSlider] = [$(".tv-xcon-slider"), $(".tv-ycon-slider"), $(".tv-zcon-slider")];
    var [tv_xPos_view, tv_yPos_view, tv_zPos_view] = [$('#tv-xpos-value'), $('#tv-ypos-value'), $('#tv-zpos-value')];
    
    var [tv_xPos_value, tv_yPos_value, tv_zPos_value] = [$('<p></p>'), $('<p></p>'), $('<p></p>')];
    
    tv_xPos_value.text(tv_xSlider.val()); tv_yPos_value.text(tv_ySlider.val()); tv_zPos_value.text(tv_zSlider.val());
    tv_xPos_view.append(tv_xPos_value); tv_yPos_view.append(tv_yPos_value); tv_zPos_view.append(tv_zPos_value);
